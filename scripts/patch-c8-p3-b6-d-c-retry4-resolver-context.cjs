...
`,
    "guard missing context and pass defaultContextId into real one-line createCategory call",
  );
  ...
  const output = {
    ok: validation.ok,
    checkId: "P4.10.0-C8-P3-B6-D-C-retry4",
  ...
  console.log("RESULT: PASS — retry4 patched resolver.ts safely.");
