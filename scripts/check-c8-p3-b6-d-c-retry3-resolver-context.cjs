...
function main() {
  ...
  const output = {
    ...
    checkId: "P4.10.0-C8-P3-B6-D-C-retry3-check",
  ...
  console.log("P4.10.0-C8-P3-B6-D-C-retry3 — resolver check");
  ...
  console.log("RESULT: PASS — retry3 resolver context patch is syntactically safe.");
}
