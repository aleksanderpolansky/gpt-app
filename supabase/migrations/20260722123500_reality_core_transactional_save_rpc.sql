-- ARCTOR REALITY CORE R1-4B
-- EXECUTABLE TRANSACTIONAL SAVE RPC MIGRATION
...
'ARCTor Reality Core transactional current-schema save RPC. Service-role only. Any failure rolls back activity_event, measures, object facts, review items and recalculation queue rows.';
