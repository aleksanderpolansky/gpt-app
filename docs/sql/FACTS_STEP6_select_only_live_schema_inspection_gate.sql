...
-- FACTS STEP 6/12 — SELECT-ONLY LIVE SCHEMA INSPECTION GATE
--
-- STATUS:
--   SELECT-ONLY INSPECTION SCRIPT.
--   DO NOT MODIFY DATA.
--
-- PURPOSE:
--   Inspect live Supabase schema before converting the Step 5 server-mediated
--   activity facts draft into an executable migration.
--
-- SAFETY:
--   This script contains SELECT statements only.
--   It must not create, alter, insert, update, delete, grant, revoke or drop anything.
--   Execute manually only after explicit SQL inspection gate decision.
--
-- EXPECTED USE:
--   Run in Supabase SQL editor when a live schema inspection is required.
--   Copy the result tables into the next audit report.
--
-- ============================================================
-- 0. Safety marker
-- ============================================================
...
-- ============================================================
-- 4. candidate actor/user/person mapping columns
-- ============================================================
...
-- ============================================================
-- 5. primary keys and foreign keys around activity/value objects
-- ============================================================
...
-- ============================================================
-- 6. indexes around activity/value object/facts candidates
-- ============================================================
...
-- ============================================================
-- 10. updated_at trigger/function candidates
-- ============================================================
...
-- ============================================================
-- 11. Existing private activity security pattern
-- ============================================================
...
-- ============================================================
-- 12. Step 5 v2 readiness checklist as query output
-- ============================================================
...
-- End of SELECT-only inspection gate.
