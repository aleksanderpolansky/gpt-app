...
export const SYSTEM_AI_GUARDS: readonly SystemGuardCatalogItem[] = [
  ...
  },
  {
    ...
    fullText: "Парсер обрабатывает explicit date/time, относительные даты, длительности, интервалы и deadline; отсутствующие доказательства не должны превращаться в выдуманную точную дату/время.",
    editable: false,
    precedenceRank: 300,
    changeMode: "code_release",
