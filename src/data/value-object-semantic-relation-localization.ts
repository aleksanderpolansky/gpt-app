...
const TITLES_BY_KEY: Record<string, LocalizedText> = {
  ...
  "valueObject.relation.classifiedAs.title": {
    ...
    ru: "Относится к типу",
    uk: "Належить до типу",
    de: "Klassifiziert als",
    es: "Se clasifica como",
    cs: "Patří k typu",
  },
  "valueObject.relation.hasClassifiedInstances.title": {
    en: "Has classified instances",
    pl: "Ma przypisane wystąpienia",
    ru: "Имеет частные проявления",
    uk: "Має конкретні прояви",
    de: "Hat klassifizierte Ausprägungen",
    es: "Tiene manifestaciones clasificadas",
    cs: "Má klasifikované projevy",
  },
...
const DESCRIPTIONS_BY_KEY: Record<string, LocalizedText> = {
  ...
  "valueObject.relation.classifiedAs.description": {
    en: "The source object is a concrete or context-specific manifestation of the target type.",
    pl: "Obiekt źródłowy jest konkretnym lub kontekstowym przejawem typu docelowego.",
    ru: "Исходный объект является конкретным или контекстным проявлением целевого типа.",
    uk: "Вихідний об’єкт є конкретним або контекстним проявом цільового типу.",
    de: "Das Ausgangsobjekt ist eine konkrete oder kontextspezifische Ausprägung des Zieltyps.",
    es: "El objeto de origen es una manifestación concreta o contextual del tipo de destino.",
    cs: "Zdrojový objekt je konkrétním nebo kontextovým projevem cílového typu.",
  },
  "valueObject.relation.hasClassifiedInstances.description": {
    en: "The current object is a general type for the related concrete or context-specific manifestations.",
    pl: "Bieżący obiekt jest typem ogólnym dla powiązanych konkretnych lub kontekstowych przejawów.",
    ru: "Текущий объект является общим типом для связанных конкретных или контекстных проявлений.",
    uk: "Поточний об’єкт є загальним типом для пов’язаних конкретних або контекстних проявів.",
    de: "Das aktuelle Objekt ist ein allgemeiner Typ für die verbundenen konkreten oder kontextspezifischen Ausprägungen.",
    es: "El objeto actual es un tipo general para las manifestaciones concretas o contextuales relacionadas.",
    cs: "Aktuální objekt je obecným typem pro související konkrétní nebo kontextové projevy.",
  },
