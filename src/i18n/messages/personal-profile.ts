...
const MESSAGES: Record<LocaleCode, PersonalProfileMessages> = {
  en: {
    ...
    imageTooLarge: "Choose a JPG, PNG or WebP image up to 10 MB. It is optimized in your browser; the original stays on your device.",
  ...
  pl: {
    ...
    imageTooLarge: "Wybierz JPG, PNG lub WebP do 10 MB. Obraz jest optymalizowany w przeglądarce; oryginał pozostaje na Twoim urządzeniu.",
  ...
  ru: {
    ...
    imageTooLarge: "Выберите JPG, PNG или WebP до 10 МБ. Изображение оптимизируется в браузере; оригинал остаётся на вашем устройстве.",
  ...
  uk: {
    ...
    imageTooLarge: "Виберіть JPG, PNG або WebP до 10 МБ. Зображення оптимізується у браузері; оригінал залишається на вашому пристрої.",
  ...
  de: {
    ...
    imageTooLarge: "Wähle JPG, PNG oder WebP bis 10 MB. Das Bild wird im Browser optimiert; das Original bleibt auf deinem Gerät.",
  ...
  es: {
    ...
    imageTooLarge: "Elige JPG, PNG o WebP de hasta 10 MB. La imagen se optimiza en el navegador; el original permanece en tu dispositivo.",
  ...
  cs: {
    ...
    imageTooLarge: "Vyberte JPG, PNG nebo WebP do 10 MB. Obrázek se optimalizuje v prohlížeči; originál zůstane ve vašem zařízení.",
