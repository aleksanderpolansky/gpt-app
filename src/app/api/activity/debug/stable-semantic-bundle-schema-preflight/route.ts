...
import {
  ...
  STABLE_SEMANTIC_BUNDLE_SCHEMA_PREFLIGHT_POLICY_V0,
...
} from "../../../../../../lib/activity/categoryDerivation/stableSemanticBundleSchemaPreflightV0";

export const dynamic = "force-dynamic";
export const runtime = "nodejs";

const ENDPOINT = "/api/activity/debug/stable-semantic-bundle-schema-preflight";
  ...
  return NextResponse.json({
    ...
    sourceContracts: {
      stableSemanticBundleSchemaPreflightPolicy:
        STABLE_SEMANTIC_BUNDLE_SCHEMA_PREFLIGHT_POLICY_V0,
      stableSemanticBundleSchemaPreflightMode:
        STABLE_SEMANTIC_BUNDLE_SCHEMA_PREFLIGHT_MODE_V0,
...
export async function POST(request: Request) {
  ...
  try {
    body = (await request.json()) as StableSemanticBundleSchemaPreflightRawInputV0;
  } catch {
    const result = buildStableSemanticBundleSchemaPreflightV0({});
  ...
  const result = buildStableSemanticBundleSchemaPreflightV0(body);
  ...
  return NextResponse.json(
    {
      ...
      execution: {
        stableSemanticBundleSchemaPreflightExecuted: result.ok,
