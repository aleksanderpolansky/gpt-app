...
const COPY: Record<LocaleCode, WorkCopy> = {
  ru: {
    ...
    loadActivities: "Показать существующие типовые активности",
  ...
  en: {
    ...
    loadActivities: "Show existing typical activities",
  ...
  pl: {
    ...
    loadActivities: "Pokaż istniejące aktywności typowe",
  ...
  uk: {
    ...
    loadActivities: "Показати наявні типові активності",
  ...
  de: {
    ...
    loadActivities: "Vorhandene typische Aktivitäten anzeigen",
  ...
  es: {
    ...
    loadActivities: "Mostrar actividades típicas existentes",
  ...
  cs: {
    ...
    loadActivities: "Zobrazit existující typické aktivity",
