...
const COPY: Record<ActivityParameterLocale, Copy> = {
  ...
  es: { title:"Catálogo de parámetros", intro:"Parámetros del sistema para objetos de observación y actividades típicas. El código técnico se define una vez al crear el parámetro y no cambia después.", create:"Nuevo parámetro", search:"Buscar parámetros…", active:"Activo", retired:"Inactivo", edit:"Editar", noItems:"No se encontraron parámetros.", technicalCode:"Código técnico", generatedCode:"Se generará automáticamente al crear", usage:"Usos", locked:"Semántica bloqueada", unlocked:"Editable", name:"Nombre", description:"Descripción", dimension:"Dimensión", valueType:"Tipo de valor", canonicalUnit:"Unidad canónica", allowedUnits:"Unidades permitidas (separadas por comas)", aggregation:"Agregación", window:"Ventana predeterminada", allowNegative:"Permitir valores negativos", save:"Guardar", saving:"Guardando…", cancel:"Cancelar", deactivate:"Desactivar", activate:"Activar", semanticLockHelp:"Este parámetro ya se utiliza. No se puede reescribir su semántica; cree un parámetro nuevo para otro significado. El estado de activación sí puede cambiarse.", created:"Parámetro creado.", updated:"Parámetro actualizado." },
