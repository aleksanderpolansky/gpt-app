...
> = {
  en: {
    ...
    catalogSubtitle:
      "Published planned activities created with the gift-certificate template. Certificates are sorted by provider reputation.",
  ...
  pl: {
    ...
    catalogSubtitle:
      "Opublikowane planowane aktywności utworzone według szablonu bonu podarunkowego. Domyślne sortowanie według reputacji dostawcy.",
  ...
  ru: {
    ...
    catalogSubtitle:
      "Опубликованные плановые активности шаблона «Подарочный сертификат». По умолчанию сертификаты отсортированы по репутации предоставляющего.",
  ...
  uk: {
    ...
    catalogSubtitle:
      "Опубліковані планові активності шаблону «Подарунковий сертифікат». Типове сортування — за репутацією надавача.",
    availableCount: "Доступно",
  ...
  de: {
    ...
    catalogSubtitle:
      "Veröffentlichte geplante Aktivitäten der Gutscheinvorlage. Standardsortierung nach Reputation des Anbieters.",
  ...
  es: {
    ...
    catalogSubtitle:
      "Actividades planificadas publicadas con la plantilla de certificado regalo. Orden predeterminado por reputación del proveedor.",
  ...
  cs: {
    ...
    catalogSubtitle:
      "Publikované plánované aktivity šablony dárkového certifikátu. Výchozí řazení podle reputace poskytovatele.",
