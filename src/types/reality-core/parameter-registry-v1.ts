...
export const PARAMETER_REGISTRY_V1 = {
  ...
  observation_count: {
    ...
    allowNegative: false,
    conversionVersion: PARAMETER_REGISTRY_VERSION,
    notesRu: "Универсальное количество, когда специализированный parameter_code ещё не определён.",
  },
  repetition_count: {
  ...
  energy_amount: {
    ...
    allowNegative: false,
    conversionVersion: PARAMETER_REGISTRY_VERSION,
    notesRu: "Нейтральное количество энергии, когда intake/expenditure/balance ещё не установлены.",
  },
  energy_intake: {
    code: "energy_intake",
  ...
  monetary_amount_eur: {
    code: "monetary_amount_eur",
    labelRu: "Денежная сумма EUR",
    dimension: "money",
    valueType: "numeric",
    canonicalUnit: "eur",
    allowedUnits: ["eur"],
    ...
    allowNegative: true,
    conversionVersion: PARAMETER_REGISTRY_VERSION,
    notesRu: "Платёж, доход, возврат или стоимость в EUR. Знак зависит от способа записи.",
  },
  monetary_amount_usd: {
    code: "monetary_amount_usd",
    labelRu: "Денежная сумма USD",
    dimension: "money",
    valueType: "numeric",
    canonicalUnit: "usd",
    allowedUnits: ["usd"],
    ...
    allowNegative: true,
    conversionVersion: PARAMETER_REGISTRY_VERSION,
    notesRu: "Платёж, доход, возврат или стоимость в USD. Знак зависит от способа записи.",
  },
  heart_rate: {
    code: "heart_rate",
